...
public class WuObject {
	...
	public var WuKey: String {
		get { fatalError("subclasses of WuObject must override WuKey") }
	}
...
public class GeoLocation {
	...
	public var LatitudeValue: Double { get { return Double.GetBestValue (lat, latitude) } }
	public var LongitudeValue: Double { get { return Double.GetBestValue (lon, longitude) } }
}
...
public class Temperature {
	...
	public var FahrenheitValue: Double { get { return Double.GetBestValue (fahrenheit, F) } }
	public var CelsiusValue: Double { get { return Double.GetBestValue (celsius, C) } }
}
